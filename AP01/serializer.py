...
from AP01.models import Prompt, Conversation
...
class ChatPromptSerializer(serializers.Serializer):
    ...
    conversation_id = serializers.IntegerField(required=True, help_text="The ID of the conversation this prompt belongs to.")
